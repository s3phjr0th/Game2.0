...
namespace Prototype.NetworkLobby
{
    public class LobbyServerList : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            //RequestPage(0);
            updateCoroutine = StartCoroutine(UpdateServerList());
        }
        ...
        {
            Dictionary<string, string> servers = lobbyManager.customNetworkDiscovery.GetActiveServers();
            ...
            else
            {
                ...
                foreach ( KeyValuePair<string,string> entry in servers)
                {
                    ...
                    o.GetComponent<LobbyServerEntry>().Populate(entry.Key, entry.Value, lobbyManager, (i % 2 == 0) ? OddServerColor : EvenServerColor);
